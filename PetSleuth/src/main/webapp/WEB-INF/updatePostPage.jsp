...
<body>
	...
	<form class="well form-horizontal" action="updatePost.do" method="post"
		id="contact_form">
		<fieldset>
				...
				<div class="col-md-4 inputGroupContainer">
					<div class="input-group">
						<span class="input-group-addon"><i
							...
							class="form-control" type="date" value="${post.lastSeen }">
					</div>
				</div>
			</div>
				...
				<div class="col-md-4 inputGroupContainer">
					<div class="input-group">
						<span class="input-group-addon"><i
							...
							class="form-control" type="text" value="${post.description }">
					</div>
				</div>
			</div>
				...
				<div class="col-md-4 inputGroupContainer">
					<div class="input-group">
						<span class="input-group-addon"><i
							...
							class="form-control" type="text" value="${post.reward }">
					</div>
				</div>
			</div>
	...
	<c:choose>
		...
		<c:otherwise>
			...
			<div class="card">
				<div class="card-header text-center">Change the pet this post refers to?</div>
				<div class="card-body">
										...
										<tr>
											<td>
												<button onclick="petValue(this.value)" type="submit"
													class="btn btn-primary" name="petId" value="${p.id}">Select</button>
											</td>
											<td>${p.id}</td>
											<td>${p.name}</td>
											<td>${p.breed}</td>
										...
										<tr>
											<td>
												<button onclick="contactValue(this.value)" type="submit"
													class="btn btn-primary" name="contactId" value="${p.id}">Select</button>
											</td>
											<td>${p.id}</td>
										...
										<tr>
											<td>
												<button onclick="locationValue(this.value)" type="submit"
													class="btn btn-primary" name="locationId" value="${p.id}">Select</button>
											</td>
											<td>${p.id}</td>
											<td>${p.street}</td>
											<td>${p.city}</td>
